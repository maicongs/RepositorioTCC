		...
		<nav class="navbar navbar-expand-md navbar-light fixed-top" style="background-color:#32CD32">
			...
			<span class="display-4"><strong>Libertas Repositório de Trabalhos</strong></span>
			 <ul class="navbar-nav mr-auto">
	          	 <li class="nav-item">
	            	<a class="nav-link" style="padding-left:50px; font-size: 25px; font-weight: bold; color: white" href="Pendentes.jsp">Pendentes</a>
	             </li>
	          	<li class="nav-item">
	            	<a class="nav-link" style="padding-right: 20px; font-size: 25px; font-weight: bold; color: white" href="Index.jsp">Logout</a>
	          	</li>
          	 </ul>
         </nav>
	</div>
