...
<title>Lista de todos os trabalhos</title>
...
<body class="p-3 mb-2 text-black" style="background-color: #90EE90">
	...
	<table class="table table-striped table-hover"/>
		...
		<%
			...
			for (Trabalho t : tdao.listarTodosTrabalhos()) {
...
<	/svg>
	...
	<a href="indexAdmin.jsp" class="btn btn-danger" style="margin-left:650px">Voltar</a>
