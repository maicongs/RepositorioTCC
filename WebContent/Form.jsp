	...
	%>
	 <div class="container">  
		<nav class="navbar navbar-expand-md navbar-light fixed-top" style="background-color:#32CD32">
			...
			<span class="display-2" style="padding-left: 120px"><strong>Enviar Trabalho de Curso</strong></span>
		</nav>
	</div>
	<br><br><br><br><br><br><br><br>
	<div class="container">
			<h3 class="mb-3" style="padding-left: 350px">Cadastrar Trabalho de Curso</h3>
			<form action="EnvioUpload" enctype="multipart/form-data" method="post"></form>
			<form class="needs-validation" novalidate>
				<div class="row">
					<div role="main" class="col-6">
						...
						<br>
						<label class="form-label"><strong style="font-size:20px">RA</strong></label>
						<input type="text" class="form-control" name="ra" value="<%= ra %>"/>
						<br>
						<label class="form-label"><strong style="font-size:20px">Email</strong></label>
						<input type="email" class="form-control" name="email" value="<%= email %>"/>
						<br>
						<label class="form-label"><strong style="font-size:20px">Curso</strong></label>
							...
							<br>
						<label class="form-label"><strong style="font-size:20px">Orientador</strong></label>
							...
							<br>
							<label class="form-label"><strong style="font-size:20px">Titulo</strong></label>
							...
							<label class="form-label"><strong style="font-size:20px">Palavras-chave</strong>
								...
								<br>
								<input class="form-control" type="text" name="palavra_chave4" value="<%= palavra_chave3 %>">
								<br>
								<input class="form-control" type="text" name="palavra_chave5" value="<%= palavra_chave3 %>">
								<br>
					...
					<aside role="complementary" class="col-6">
						...
						<a href="MensagemTrabalhoEnviado.jsp" class="btn btn-primary">Salvar</a>
